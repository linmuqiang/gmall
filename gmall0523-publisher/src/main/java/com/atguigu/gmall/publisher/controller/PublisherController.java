...
public class PublisherController {
    ...
    public Object saleDetail(@RequestParam("keyword") String keyword, @RequestParam("date") String dt) {
        if (keyword == null) {
            keyword = "";
        }
        System.err.println(JSONArray.toJSONString(clickHouseService.getOrderDetail(dt, keyword)));
        return JSONArray.toJSONString(clickHouseService.getOrderDetail(dt, keyword));
    }

    @RequestMapping("/realtime-sex")
    public String realtimeSex(@RequestParam("dt") String dt, @RequestParam("type") String type) {
        if ("age".equals(type)) {
            return JSONArray.toJSONString(clickHouseService.getAgePie(dt));
        }
        return JSONArray.toJSONString(clickHouseService.getSexPie(dt));
    }
